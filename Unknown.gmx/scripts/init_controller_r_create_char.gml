...
with(body_button_back){
    set_o_button_back(instance_find(o_character, 0), instance_find(o_label_body, 0), update_o_button_back, "BODY");
}
with(body_button_next){
    set_o_button_next(instance_find(o_character, 0), instance_find(o_label_body, 0), update_o_button_next, "BODY");
}
...
with(body_button_back){
    set_o_button_back(instance_find(o_character, 0), instance_find(o_label_head, 0), update_o_button_back, "HEAD");
}
with(body_button_next){
    set_o_button_next(instance_find(o_character, 0), instance_find(o_label_head, 0), update_o_button_next, "HEAD");
}
...
with(body_button_back){
    set_o_button_back(instance_find(o_character, 0), instance_find(o_label_shirt, 0), update_o_button_back, "SHIRT");
}
with(body_button_next){
    set_o_button_next(instance_find(o_character, 0), instance_find(o_label_shirt, 0), update_o_button_next, "SHIRT");
}
...
with(body_button_back){
    set_o_button_back(instance_find(o_character, 0), instance_find(o_label_pants, 0), update_o_button_back, "PANTS");
}
with(body_button_next){
    set_o_button_next(instance_find(o_character, 0), instance_find(o_label_pants, 0), update_o_button_next, "PANTS");
}
